...
export const products = [
  ...
  // --- Próximamente ---
  {
    ...
    price: "Consultar",
    isNew: true,
    arrivedAt: "Hace 2 días",
    code: "MODM-00II",
    kit: "Kit x 50 unidades",
    image: "/images/smartwatch-mixor-activo-bluetooth-ecg-mayorista-argentina.webp",
    modalImage: "/images/smartwatch-mixor-activo-correas-intercambiables-7en1-modal.webp",
    description: "Smartwatch premium con monitoreo ECG, llamadas y música Bluetooth, 7 correas intercambiables y múltiples modos deportivos.",
    features: [
      { icon: Heart, title: "Monitoreo de Salud Completo", description: "Tres anillos de salud con frecuencia cardíaca, presión arterial y oxígeno en sangre en tiempo real. Incluye monitoreo ECG de precisión." },
      { icon: Phone, title: "Llamadas y Música Bluetooth", description: "Atendé llamadas y escuchá tu música directamente desde tu muñeca, sin sacar el teléfono." },
      { icon: Activity, title: "Seguimiento del Sueño", description: "Análisis detallado de tus ciclos de sueño para mejorar tu descanso día a día." },
      { icon: Sparkles, title: "Notificaciones Inteligentes", description: "Recordatorios de llamadas, SMS, redes sociales y eventos. Incluye alarma y recordatorio de sedentarismo." },
      { icon: Zap, title: "Múltiples Modos Deportivos", description: "Medí tu rendimiento en cada entrenamiento con sus variados modos de actividad física." },
      { icon: Settings, title: "Funciones Prácticas", description: "Encendido por giro de muñeca, buscador de teléfono, control remoto de cámara, carátulas personalizables, modo avión y clima en tiempo real." },
    ],
  },
  {
    id: 31,
    ...
    price: "Consultar",
    isNew: true,
    arrivedAt: "Hace 10 días",
    code: "MODM-00H1",
    kit: "Kit x 200 unidades",
    image: "/images/cable-mixor-eternidad-tipo-c-carga-rapida-7amp-mayorista.webp",
    modalImage: "/images/cable-mixor-eternidad-tipo-c-lifestyle-modal.webp",
    description: "Cable USB-A a Tipo C 7.1A con nylon trenzado blanco, conectores reforzados y carga ultra rápida.",
    features: [
      { icon: Zap, title: "Carga Ultrarrápida 7.1A", description: "Soporta hasta 7.1 Amperios para una carga ultra rápida y eficiente de smartphones, tablets y otros dispositivos Tipo C." },
